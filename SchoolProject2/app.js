window.onload = function() {
  ...
  fetch('https://cors-anywhere.herokuapp.com/https://github.com/rannej13/Test/blob/master/SchoolProject2/SchoolResultsAberdeen.csv',  { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
